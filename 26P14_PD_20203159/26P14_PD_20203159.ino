...
// Distance sensor
#define _DIST_ALPHA 0.3  //ema 필터의 alpha 값을 0.0으로 설정

// Servo range
#define _DUTY_MIN 1500    //서보의 가동 최소 각도(0)
#define _DUTY_NEU 1700    //servo neutral position (90 degree)
#define _DUTY_MAX 1850    //서보의 최대 가동 각도(180º)

// Servo speed control
#define _SERVO_ANGLE 20   //레일플레이트가 사용자가 원하는 가동범위를 움직일때, 이를 움직이게 하는 서보모터의 가동범위
#define _SERVO_SPEED 100   //서보 속도
...
const float coE[] = {0.0000002, 0.0020998, 0.5288819, 54.2121938};

float _dist_[] = {73, 115, 131, 186, 257, 323, 401};
